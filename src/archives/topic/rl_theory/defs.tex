...
\def\SV{\ensuremath{\rm S}}
\def\SS{\ensuremath{\rm s}}
\def\AV{\ensuremath{\rm A}}
\def\A{\ensuremath{\mathbf A}}
\def\AA{\ensuremath{\rm a}}
\def\RW{{R}}

\def\T{\ensuremath{T}}
\def\TT{\ensuremath{t}}
\def\TTM{\ensuremath{\TT - 1}}
\def\ST{\ensuremath{\mathbf \Pi}}
\def\STT{\ensuremath{\pi}}

\def\PSTT{\ensuremath{\P_{\STT}}}
\def\ESTT{\ensuremath{{\mathbb E}_{\STT}}}

\def\PP{\ensuremath{\rm P}}
\def\PIND{\ensuremath{\PP_{\rm I}}}
\def\PACT#1#2#3#4{\ensuremath{\PP_{{\rm A}}\left(#1, #2 : #3 \mid #4\right)}}
\def\PTRD#1#2#3{\ensuremath{\PP_{\rm T}\left(#1 \mid #2, #3\right)}}

\def\astr{\ensuremath{\STT \in \ST}}
% ---
