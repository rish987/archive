...
$(addsuffix /archives/topic/rl_theory/ref.pdf,${TREE_DIRS}) ${ARCHIVES_F} ${ARCHIVES_F_C}: ${RL_T_INP_ACT} ${RL_T_INP_REW} $(addprefix ${RL_T_D}/parts/,notation.tex example.tex preliminaries.tex)
