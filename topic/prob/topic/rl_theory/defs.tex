\def\rltpath{archive/topic/prob/topic/rl_theory}
...
\def\PSTTP{\enm{\lngraw{\rltpath/definition/pstr}{\P_{\STT}}}}
...
\def\ESTT#1{\enm{\lngraw{\rltpath/definition/estr}{{\mathbb E}_{\STT}\left[#1\right]}}}

\def\PP{\enm{\lngraw{\rltpath/note/paramprob}{\rm P}}}
...
\def\fnnot#1#2#3{\enm{\lngraw{\rltpath/note/fnnot}{#1 : #2 \rightarrow #3}}}

\def\aprod#1#2#3{\enm{\lngraw{\rltpath/note/prodnot}{\prod_{#1}^{#2}#3}}}
