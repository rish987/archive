...
\begin{part}{Notation}
  ...
  \nrp 39
  \reflnenv{proof}{mprsqexpr}{It follows that}{, \mprsqexprprop.}
  ...
  \nrp 34
  \reflnenv{proof}{mprobexpr}{It follows that}{, \mprobexprprop.}
...
\begin{part}{Notation}
  ...
  \nrp 30
  \reflnenv{proof}{evcexpr}{It follows that}{, \evcexprprop.}
