...
\begin{part}{Propositions}
  ...
  \reflnenv{proof}{sqpplimdef}{It can be shown}{ that, \sqpplimdefprop.}

  \reflnenv{proof}{sqprobsumone}{It can be shown}{ that, \sqprobsumoneprop.}

  \reflnenv{proof}{sqmprobsumone}{It can be shown}{ that, \sqmprobsumoneprop.}

  \reflnenv{proof}{sqcprobsumone}{It can be shown}{ that, \sqcprobsumoneprop.}

  \reflnenv{proof}{sqmarggimplcond}{It can be shown}{ that, \sqpmarggimplcondprop.}
\end{part}
...
\begin{part} {Propositions}
  ...
  \reflnenv{proof}{indcptomp}{It can be shown}{ that, \indcptompdef.}

  \reflnenv{proof}{indsymm}{It can be shown}{ that, \indsymmdef.}

  \reflnenv{proof}{inddecomp}{It can be shown}{ that, \inddecompdef.}

  \reflnenv{proof}{indwun}{It can be shown}{ that, \indwundef.}

  \reflnenv{proof}{indcontr}{It can be shown}{ that, \indcontrdef.}

  \reflnenv{proof}{indinter}{It can be shown}{ that, \indinterdef.}
\end{part}

\begin{part} {Notation}
  \reflnenv{definition}{imap}{Define}{, \imapdef.}

  \reflnenv{definition}{dmap}{Define}{, \dmapdef.}

  \reflnenv{definition}{pmap}{Define}{, \pmapdef.}

  \reflnenv{definition}{pmape}{Define}{, \pmapedef.}
\end{part}

\begin{part} {Propositions}
  \reflnenv{proof}{pmape}{It can be shown}{ that, \pmapeprop.}
\end{part}
