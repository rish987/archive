...
\begin{part}{Notation}
  ...
  \reflnenv{definition}{undir}{Define}{ \undirdef.}
...
\begin{part} {Propositions}
  ...
  \reflnenv{proof}{pathtrans}{It can be shown}{ that, \pathtransprop.}
  \reflnenv{proof}{pathud}{It can be shown}{ that, \pathudprop.}
  \reflnenv{proof}{pathsubcondf}{It can be shown}{ that, \pathsubcondfprop.}
  \reflnenv{proof}{pathsubcond}{It can be shown}{ that, \pathsubcondprop.}
  \reflnenv{proof}{pathsubless}{It can be shown}{ that, \pathsublessprop.}
  \reflnenv{proof}{pathswap}{It can be shown}{ that, \pathswapprop.}
  \reflnenv{proof}{pathswapud}{It can be shown}{ that, \pathswapudprop.}
\end{part}
\begin{part}{Topics}
